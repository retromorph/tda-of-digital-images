...
group.add_argument("--d_hidden", type=int, help="MLP hidden dim", default=192)
...
# model
model = PersistentHomologyTransformer(None, 9, meta.n_classes, args.d_model, args.d_hidden, args.num_heads, args.num_layers, args.agg, args.norm, args.dropout, args.activation, args.alpha, args.norm_first)
