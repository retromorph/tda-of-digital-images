...
parser = argparse.ArgumentParser(
    ...
    usage="python3 run_kan.py --dataset MNIST"
)
...
# model
group.add_argument("--model", help="Model", default="KAN")
group.add_argument("--d_hidden", type=int, help="Hidden dim", default=128)
group.add_argument("--n_layers", type=int, help="Number of hidden layers", default=2)
group.add_argument("--dropout", type=int, help="Dropout", default=0.1)
group.add_argument("--activation", help="Activation", default="SILU")
...
# model
model = KAN(meta.dim**2, meta.n_classes, args.d_hidden, n_layers=args.n_layers)

print("Data:\t\t {}, transform={}, power={}".format(args.dataset, args.transform, args.power))
print("Model:\t\t d_hidden={}, num_layers={}".format(args.d_hidden, args.n_layers, args.dropout, args.activation, int(args.norm_first)))
