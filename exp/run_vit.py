...
group.add_argument("--n_heads", type=int, help="N heads", default=8)
group.add_argument("--n_blocks", type=int, help="N blocks", default=2)
...
# workers
group.add_argument("--num_workers", type=int, help="N workers", default=6)
...
# model
model = ViT(meta.dim, meta.n_classes, args.d_model, args.d_hidden, args.n_heads, args.n_blocks, args.patch_size, dropout=args.dropout)

print("Data:\t\t {}, transform={}, power={}".format(args.dataset, args.transform, args.power))
print("Model:\t\t {}, d_model={}, d_hidden={}, n_heads={}, n_blocks={}, dropout={}, f={}, pre_ln={}".format(args.model, args.d_model, args.d_hidden, args.n_heads, args.n_blocks, args.dropout, args.activation, int(args.norm_first)))
